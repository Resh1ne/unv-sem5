...
class CustomConnectionPool {
    ...
    CustomConnectionPool(String driver, String url, String user, String password, int poolSize) {
    ...
    public void releaseConnection(Connection connection) {
        if (connection instanceof ProxyConnection proxyConnection && givenConnections.remove(connection)) {
